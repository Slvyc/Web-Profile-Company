<footer class="footer-area bg-light py-5">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4 mb-4 mb-md-0">
        <h3>About Us</h3>
        <p>At Zanpro, we pride ourselves on being a trusted and reputable name in the real estate industry with years of experience.</p>
      </div>
      <div class="col-md-4 mb-4 mb-md-0">
        <h3>Contact Info</h3>
        <p>13 Fifth Avenue, New York, NY 101660</p>
        <p>contact@zanpro.com</p>
        <p>555-345-4599</p>
      </div>
      <div class="col-md-4">
  ...
  <div class="footer-bottom mt-5 bg-dark text-white py-3">
    <div class="container">
