...
<section id="property-search" class="py-5 bg-light">
  <div class="container">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 mb-4 mb-lg-0">
        <img src="img/about-us-image.jpg" alt="Zanpro Real Estate Team" class="img-fluid rounded shadow">
      </div>
      <div class="col-lg-6">
        ...
        <ul class="list-unstyled mb-4">
          <li><i class="fas fa-check text-primary me-2"></i> Pilihan properti premium</li>
          <li><i class="fas fa-check text-primary me-2"></i> Tim agen berpengalaman</li>
          <li><i class="fas fa-check text-primary me-2"></i> Layanan konsultasi profesional</li>
          <li><i class="fas fa-check text-primary me-2"></i> Proses transaksi yang transparan</li>
        </ul>
...
<section id="news" class="py-5 bg-light">
  <div class="container">
    ...
    <div class="row g-4">
      <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm">
          <img src="img/news-1.jpg" class="card-img-top" alt="Berita 1">
          <div class="card-body">
            <h5 class="card-title">Tren Desain Interior 2023</h5>
      ...
      <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm">
          <img src="img/news-2.jpg" class="card-img-top" alt="Berita 2">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm">
          <img src="img/news-3.jpg" class="card-img-top" alt="Berita 3">
          <div class="card-body">
